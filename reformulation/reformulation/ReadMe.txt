========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet reformulation
========================================================================

AppWizard a créé cette application reformulation pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application reformulation.


reformulation.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé reformulation.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
